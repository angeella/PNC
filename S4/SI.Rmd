...
$$s_X=\sqrt{\frac{1}{n-1}\sum_{i=1}^{n}(X-\bar{X})^2}$$

is the **sample standard deviation** and $n$ the sample size. This introduces an additional level of uncertainty and also a complication. **The complication arises from the fact that for small samples, sample estimates of the standard deviation tend to be biased (lower) compared to the true population standard deviation.**
