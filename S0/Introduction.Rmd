...
- `R` $\rightarrow$ [https://cran.r-project.org/](https://cran.r-project.org/)

--

- `Rstudio`, i.e., integrated development environment (IDE) for making R easier to utilize $\rightarrow$ [https://www.rstudio.com/products/rstudio/download/#download](https://www.rstudio.com/products/rstudio/download/#download)

--

- `GitHub desktop` permits to share code and data $\rightarrow$ [https://desktop.github.com/](https://desktop.github.com/)
