...
- **Reproducibility in Neuroscience**: main concepts, when we fall into it, and how to fix it (we will jump it this year but you can find the materials in [the GitHub repository](https://github.com/angeella/PNC),
...
- **Introduction to Statistical Inference**, i.e. how to make inferential conclusions:
